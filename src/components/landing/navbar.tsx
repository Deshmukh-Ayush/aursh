  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex h-16 items-center justify-between px-6 md:px-12 bg-background/50 backdrop-blur-xl border-b border-white/5">
      ...
      <div className="flex items-center gap-6">
        <Link 
          href="https://github.com/Deshmukh-Ayush/Scrunity" 
          target="_blank"
        ...
        <Button asChild className="h-9 rounded-full px-5 font-medium active:scale-[0.96] transition-transform shadow-lg shadow-primary/20">
