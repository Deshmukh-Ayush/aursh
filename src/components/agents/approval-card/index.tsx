        ...
        <div className="min-w-0 flex-1">
          <div className="flex min-w-0 items-start gap-3">
            ...
            {questionMode && interactive ? (
              <span className="shrink-0 text-[13px] tabular-nums text-muted-foreground/65">
                {currentStep + 1}/{questions.length}
              </span>
            ) : (
              <span
                className={cn(
                  "shrink-0 rounded-full border px-2 py-0.5 text-[13px] font-medium transition-colors",
