  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col rounded-md border border-border/40 bg-neutral-100 p-1 shadow-xs dark:bg-neutral-900">
        <div className="flex flex-col gap-5 rounded-md bg-white p-6 dark:bg-neutral-950">
      ...
      {/* Theme Preference */}
      <div className="flex flex-col rounded-md border border-border/40 bg-neutral-100 p-1 shadow-xs dark:bg-neutral-900">
        <div className="flex flex-col gap-4 rounded-md bg-white p-6 dark:bg-neutral-950">
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-wide text-foreground">
              Interface Theme
            </h2>
      ...
      {/* Account Security */}
      <div className="flex flex-col rounded-md border border-border/40 bg-neutral-100 p-1 shadow-xs dark:bg-neutral-900">
        <div className="flex items-center justify-between rounded-md bg-white p-6 dark:bg-neutral-950">
